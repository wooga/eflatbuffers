defmodule EflatbuffersWriterTest do
  ...
  test "write ushort" do
    ...
    assert {:error, {:wrong_type, :ushort, 65_536_123, []}} ==
             catch_throw(write(:ushort, 65_536_123))
  ...
  test "write vectors" do
    ...
    assert(
      [
        ...
        [
          [<<8, 0, 0, 0>>, <<11, 0, 0, 0>>],
          [<<3, 0, 0, 0, 102, 111, 111>>, <<3, 0, 0, 0, 98, 97, 114>>]
        ]
      ] ==
        Eflatbuffers.Writer.write(
          {:vector, %{type: {:string, %{}}}},
  ...
  test "data buffer" do
    ...
    reply =
      Eflatbuffers.Writer.data_buffer_and_data(
        [
          {:the_bool, {:bool, %{}}},
          {:the_string, {:string, %{}}},
          {:the_string2, {:string, %{}}},
